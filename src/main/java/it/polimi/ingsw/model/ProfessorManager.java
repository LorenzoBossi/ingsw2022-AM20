...
import it.polimi.ingsw.network.messages.serverMessage.ChangeProfessor;
...
public class ProfessorManager extends ObservableSubject {
    ...
    public void takeProfessor(Player player, Color color) {
        Player previousOwner = owners.get(color.ordinal());
        String oldOwner = null;
        if (previousOwner != null)
            oldOwner = previousOwner.getNickname();
        ...
        notifyObserver(new ChangeProfessor(player.getNickname(), oldOwner, color));
    }
